...
const BANNED = [
  [/gunnar|gabrielson/i, "the maintainer's name or machine", ["scripts/scrub.test.mjs"]],
  [/gunn4r/i, "the maintainer's account — only the repository URL may carry it",
    ["package.json", "package-lock.json", "README.md", "CONTRIBUTING.md", "SECURITY.md", "RELEASING.md",
     ...
     "LICENSE"]],
  [/ultima_online/i, "the private workspace path", ["scripts/scrub.test.mjs"]],
  [/\/Users\/(?!example)[a-z0-9._-]+/i, "a real home directory", ["scripts/scrub.test.mjs"]],
  [/\b(Mythos|Titania|Tenthumbs)\b/, "a real character name", ["scripts/scrub.test.mjs"]],
  [/quartermaster/i, "the retired product name", ["scripts/scrub.test.mjs"]],
];
