...
- The scan and bridge file parsers (`app/scan-schema.mts`, `app/watcher.mts`, the bridge protocol handling in `app/vault-server.mjs`) — anything that reads a file an adapter script or a player produced.
